...
def create_pull_request(target: str, yes: bool, diff: bool) -> None:
    ...
    with richprint.live_progress(f"Gathering Facts ..."):
        repo_id = None
    ...
    if yes or prompt("\nProceed [y/n]").lower().strip() == 'y':
        ...
        if pull_request[0] == 201:
            ...
            if 'existingPullRequest' in pull_request[1]:
                ...
                richprint.to_console(header, {'\u26A1 Message': pull_request[1]['errors'][0]['message']}, False)
        else:
